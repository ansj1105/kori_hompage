...
import { newsPosts, type NewsCategory, type NewsPost } from '../data/newsPosts';
...
export function NewsPage() {
        ...
        {currentFeaturedPost && (
            ...
            <div className="news-page__container">
                ...
                <div className="news-page__featured-image">
                    ...
                    alt={isKo ? currentFeaturedPost.titleKo : currentFeaturedPost.titleEn}
                    />
                </div>
                ...
                <div className="news-page__featured-content">
                    ...
                    <h2>{isKo ? currentFeaturedPost.titleKo : currentFeaturedPost.titleEn}</h2>
                    <p>{isKo ? currentFeaturedPost.summaryKo : currentFeaturedPost.summaryEn}</p>
            ...
            <div className="news-page__container">
                ...
                {pinnedPosts.map((post) => (
                    ...
                    <div className="news-page__pinned-left">
                        <Pin size={16} />
                        <strong>{isKo ? post.titleKo : post.titleEn}</strong>
                    </div>
    ...
    return (
        ...
        <div className="news-page__card-image">
            <NewsImage src={post.thumbnail} alt={isKo ? post.titleKo : post.titleEn} />
        </div>
        ...
        <div className="news-page__card-body">
            ...
            <h3>{isKo ? post.titleKo : post.titleEn}</h3>
            <p>{isKo ? post.summaryKo : post.summaryEn}</p>
